.. based on NumPy's documentation
...
.. grid:: 2
   ...
   .. grid-item-card::
      ...
      How to install **SarcGraph**

      +++

      .. button-ref:: installation_ref
         :expand:
         :color: secondary
         :click-parent:
   ...
   .. grid-item-card::
      ...
      Check out demos and tutorials that contain introduction to all features 
      of **SarcGraph**

      +++

      .. button-ref:: demos_ref
         :expand:
         :color: secondary
         :click-parent:
